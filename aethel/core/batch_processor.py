...
from aethel.core.parallel_executor import ParallelExecutor
...
try:
    from aethel.core.parser import AtomicBatchNode
except ImportError:
...
class BatchProcessor:
    ...
    def _execute_serial(self,
        ...
        """
        from aethel.core.synchrony import ExecutionEvent, EventType
