...
The "Selo de Gênesis" (Genesis Seal) - Proof for lawyers and regulators.
...
def demo_3_export_html_dashboard():
    ...
    print(f"⏱️  Export Time: {export_time*1000:.2f}ms")
    print(f"\n📊 Dashboard Features:")
    print(f"   • Real-time statistics cards")
    print(f"   • Attack distribution charts")
    print(f"   • Recent attacks timeline")
    print(f"   • Compliance status indicators")
...
def demo_4_export_csv_data():
    ...
    print(f"⏱️  Export Time: {export_time*1000:.2f}ms")
    print(f"\n📊 CSV Features:")
    print(f"   • Timestamp for each attack")
    print(f"   • Attack type and category")
    print(f"   • Severity scores")
    print(f"   • Detection method")
    print(f"   • Blocking layer")
    print(f"\n💼 Use Cases:")
    print(f"   • Import into Excel for pivot tables")
    print(f"   • Load into data analysis tools (pandas, R)")
    print(f"   • Share with auditors and compliance teams")
...
def demo_5_multi_format_consistency():
    ...
    print(f"📊 Statistics from Database:")
...
def demo_6_performance_benchmark():
    ...
    print(f"📊 Dataset: {attack_count} attacks")
    
    # Benchmark PDF generation
    print(f"\n⏱️  Benchmarking PDF generation...")
    start_time = time.time()
    metadata = report.generate_compliance_pdf(
...
def main():
    ...
    try:
        ...
        # Final summary
        print("\n" + "="*80)
        print("🎉 COMPLIANCE REPORT DEMO COMPLETE")
        print("="*80)
        print("\n✅ All demos executed successfully!")
        print("\n📁 Generated Files:")
        print("   • reports/compliance_report.pdf (Professional PDF)")
        print("   • reports/compliance_report_metadata.json (Signature)")
        print("   • reports/compliance_dashboard.html (Interactive HTML)")
        print("   • reports/compliance_data.csv (Data Export)")
        print("\n🔐 The Genesis Seal:")
        ...
        print("\n🏛️  DIOTEC 360 - Compliance-Grade Security")
        print("="*80 + "\n")
