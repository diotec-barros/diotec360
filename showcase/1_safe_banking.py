...
from aethel.stdlib.financial.interest import compound_interest
from aethel.stdlib.financial.amortization import loan_payment, amortization_schedule
from aethel.stdlib.financial.risk import value_at_risk, sharpe_ratio
